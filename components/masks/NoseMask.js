...
export const NoseMask = ({ algo_tech_name, imageData }) => {
    ...
    return (
        <div>
            ...
            <svg preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg" ref={svgHolder}>
                ...
                <clipPath id="NoseMaskPolygons" ref={polygonsHolder} />
                {/* img to clip */}
                <image id="image" width="812" height="812" clipPath="url(#NoseMaskPolygons)" ref={imageHolder} />
                <g id="subPolygons" clipPath="url(#NoseMaskPolygons)" ref={groupHolder} />
            </svg>
        </div>
    );
