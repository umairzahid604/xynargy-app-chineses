...
export const ChinMask = ({ algo_tech_name, imageData }) => {
    ...
    return (
        <div>
            ...
            <svg preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg" ref={svgHolder}>
                ...
                <clipPath id="ChinMaskPolygons" ref={polygonsHolder} />
                {/* img to clip */}
                <image id="image" width="812" height="812" clipPath="url(#ChinMaskPolygons)" ref={imageHolder} />
                <g id="subPolygons" clipPath="url(#ChinMaskPolygons)" ref={groupHolder} />
            </svg>
        </div>
    );
