...
export const FaceMask = ({ algo_tech_name, imageData }) => {
    ...
    return (
        <div>
            ...
            <svg preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg" ref={svgHolder}>
                ...
                <clipPath id="FaceMaskPolygons" ref={polygonsHolder} />
                {/* img to clip */}
                <image id="image" width="812" height="812" clipPath="url(#FaceMaskPolygons)" ref={imageHolder} />
                <g id="subPolygons" clipPath="url(#FaceMaskPolygons)" ref={groupHolder} />
            </svg>
        </div>
    );
